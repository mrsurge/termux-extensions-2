...
From the current `0.2.341` alpha release. The alpha label describes product
...
Set `TE2_RELEASE_TAG=0.2.341` and use the matching tagged download URL when an
...
python -m pip install "te2==0.2.341"
te2
```
