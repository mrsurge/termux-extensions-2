...
.te-dialog-title{min-width:0;flex:1;font-size:1rem;font-weight:650}.te-dialog-close{width:32px;height:30px;border:0;border-radius:5px;background:transparent;color:inherit;font-size:18px;cursor:pointer}.te-dialog-close:hover{background:rgba(148,163,184,.14)}
.te-dialog-body{display:flex;flex-direction:column;gap:12px;padding:16px 18px;overflow:auto}.te-dialog-message,.te-dialog-detail{margin:0;white-space:pre-wrap;line-height:1.5}.te-dialog-detail{opacity:.78;font-size:.9em}
...
.te-dialog-field{display:flex;flex-direction:column;gap:6px}.te-dialog-field-label{font-weight:600}.te-dialog-field-description{opacity:.74;font-size:.88em;line-height:1.4}
.te-dialog-input,.te-dialog-textarea,.te-dialog-select-button{width:100%;min-height:38px;padding:8px 10px;border:1px solid var(--border,#3b4652);border-radius:7px;background:var(--input,var(--secondary,#0e141b));color:inherit;font:inherit}.te-dialog-textarea{resize:vertical;line-height:1.4}.te-dialog-input:focus,.te-dialog-textarea:focus,.te-dialog-select-button:focus{outline:2px solid var(--primary,#5b8dff);outline-offset:1px}
...
.te-dialog-select{position:relative}.te-dialog-select-button{text-align:left;cursor:pointer}.te-dialog-select-menu{position:absolute;z-index:2;left:0;right:0;top:calc(100% + 4px);max-height:220px;overflow:auto;padding:5px;border:1px solid var(--border,#3b4652);border-radius:7px;background:var(--card,#111820);box-shadow:0 14px 30px rgba(0,0,0,.45)}.te-dialog-select-menu[hidden]{display:none}.te-dialog-select-option{display:block;width:100%;padding:8px 10px;border:0;border-radius:5px;background:transparent;color:inherit;text-align:left;cursor:pointer}.te-dialog-select-option:hover,.te-dialog-select-option[aria-selected="true"]{background:rgba(91,141,255,.18)}
.te-dialog-error{min-height:1.2em;color:var(--destructive,#ef4444);font-size:.88em}.te-dialog-actions{display:flex;justify-content:flex-end;gap:8px;padding:11px 14px;border-top:1px solid var(--border,#343b44)}.te-dialog-action{min-height:36px;padding:7px 14px;border:1px solid var(--border,#3b4652);border-radius:7px;background:var(--secondary,#1b2530);color:inherit;font:inherit;cursor:pointer}.te-dialog-action:hover{filter:brightness(1.12)}.te-dialog-action[data-primary="true"]{border-color:var(--primary,#5b8dff);background:var(--primary,#5b8dff);color:var(--primary-foreground,#fff)}.te-dialog-action[data-role="destructive"]{border-color:var(--destructive,#b91c1c);background:var(--destructive,#b91c1c);color:#fff}
