...
export const EXTENSION_MANIFEST_URL =
  "/apps/file_editor_cm6/extensions/sidebar_extension/manifest.json";
...
export const SIDEBAR_SETUP_HINT_DEFAULT =
  "Use the launcher to open an app dock slot, or add a URL slot.";
