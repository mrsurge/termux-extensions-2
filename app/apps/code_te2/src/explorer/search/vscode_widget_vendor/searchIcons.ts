...
import { localize } from '/static/vendor/monaco-editor-core/esm/vs/nls.js';
import { registerIcon } from '/static/vendor/monaco-editor-core/esm/vs/platform/theme/common/iconRegistry.js';
