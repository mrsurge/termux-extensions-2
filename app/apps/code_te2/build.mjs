...
const workbenchAdapterConfig = {
  entryPoints: [
    ...
    'workbench_protocol_proxy/node_workbench_adapter/src/client/client-operation-gate.ts',
    ...
    'workbench_protocol_proxy/node_workbench_adapter/src/extensions/editor-navigation-runtime.ts',
