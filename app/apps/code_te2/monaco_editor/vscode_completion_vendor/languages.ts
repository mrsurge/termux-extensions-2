 ...
 * as comments so the app bundle only ships the completion contract we actually use.
 * Source: worktrees/vscode-te2-diff/src/vs/editor/common/languages.ts
 */

export enum VscodeCompletionTriggerKind {
  Invoke = 0,
  TriggerCharacter = 1,
  TriggerForIncompleteCompletions = 2,
}

export interface VscodeCompletionContextLike {
  triggerKind: VscodeCompletionTriggerKind | number;
  triggerCharacter?: string;
}

export interface VscodeCompletionListLike {
