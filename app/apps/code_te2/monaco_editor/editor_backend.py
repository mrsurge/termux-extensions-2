...
# app/apps/code_te2/monaco_editor/editor_backend.py
...
def _normalize_rel_path(project_root: Path, raw_path: str) -> str:
    from app.apps.code_te2.explorer.services import file_ops as _file_ops
...
def _collect_diff(project_root: Path, rel_path: str, base_ref: str | None = None) -> dict[str, object]:
    from app.apps.code_te2 import diff_helper as _diff_helper
...
def _compute_draft_diff(file_path: str, draft_content: str, disk_content: str) -> dict[str, object]:
    from app.apps.code_te2 import draft_diff_helper as _draft_diff_helper
