...
import com.termux.extensions.nativeeditor.sidebar.NativeSidebarLayer
...
internal fun NativeCodeTe2Screen(
    ...
    val sidebarState by controller.sidebar.state
    MaterialTheme {
            ...
            Column(modifier = Modifier.fillMaxSize()) {
                ...
                Box(modifier = Modifier.weight(1f).fillMaxWidth()) {
                    ...
                    NativeSidebarLayer(
                        ...
                        state = sidebarState,
                        visible = state.overlay == NativeEditorOverlay.SIDEBAR,
