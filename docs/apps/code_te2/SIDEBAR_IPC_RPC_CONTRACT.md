...
- the consolidated `code_te2` app Socket.IO gateway path, preserving `/sidebar_ipc` as the logical namespace unless a later contract revision removes it.
...
- `app/apps/code_te2/src/sidebar_ipc/rpc_contract.ts`
- `app/apps/code_te2/ui_ipc/sidebar_rpc_contract.py`

Current implementation/source surfaces:

- `app/apps/code_te2/ui_ipc/sidebar_ws.py`
- `app/apps/code_te2/host/project_backend.py`
- `app/apps/code_te2/main_page/backend/project_service.py`
- `app/apps/code_te2/main_page/frontend/sidebar-shortcuts/runtime.ts`
- `app/apps/code_te2/main_page/frontend/sidebar-shortcuts/`
- `app/apps/code_te2/main_page/frontend/ui/sidebar-shortcuts-bootstrap.ts`
- `app/apps/code_te2/main_page/frontend/host-sidebar-runtime.ts`
