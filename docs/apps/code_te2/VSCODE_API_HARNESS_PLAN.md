...
- Host service `app/apps/code_te2/services/vscode_api_transport.py` proxies frames verbatim to the shell.
...
- Monaco stays in the iframe (`app/apps/code_te2/monaco_editor/m_editor_app.py` + `m_editor_app.js`).
- Monaco consumes:
