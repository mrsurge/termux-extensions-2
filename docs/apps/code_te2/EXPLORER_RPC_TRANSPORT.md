...
This document describes the live Explorer-owned frontend/backend transport in `code_te2` after the Explorer JSON-RPC cutover.
...
- `app/apps/code_te2/explorer/transport/socketio_app.py`
