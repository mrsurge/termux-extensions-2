...
3. `project_routes.py`
   ...
   - completed: strict project route factory now lives at `main_page/backend/project_routes.py`; `main.py` assembles terminal, diagnostics, adapter, sidebar, and project-creation dependencies without owning the route bodies
4. `git_routes.py`
